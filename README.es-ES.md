...
> **Fork/Port de [nvm-sh/nvm](https://github.com/nvm-sh/nvm) (`nvm.sh` v0.40.7) a Windows 11 nativo + PowerShell 7+.**
> **La CLI sigue siendo `nvm` para paridad 1:1 (`nvm install`/`use`/`ls`). El módulo/producto es `nvm-ps`.**

> 🌐 **Idioma:** [English (US)](README.md) | **Español (España)**
